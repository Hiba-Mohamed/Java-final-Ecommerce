        ...
        while (true) {
            ...
            switch (choice) {
                ...
                case 2:
                    ...
                    System.out.println("|  Attention !!!! deleting a user, deletes their associated products also.  |");
                    System.out.println("___________________________________________________________________________");
                    System.out.println("Enter username to delete: "); // Use println to move input to the next line
